...
*   **บทบาทในฉาก:** พนักงานไอทีที่คอยมอนิเตอร์หลังบ้าน (Backend/Frontend Logs) 
*   **หน้าที่หลัก:** ดักจับ Error และปัญหา Performance บนหน้าเว็บและระบบหลังบ้าน หากพบข้อผิดพลาด จะประสานงานกับ AI Assistant ให้ถาม Mxrk ทันทีว่าต้องการแก้ไขหรือไม่
*   **Animation States:**
    *   `idle` — เดินไปเดินมารอบๆ โต๊ะ คอยดูแลและตรวจสอบความเรียบร้อยของระบบ
    *   `alert` — ไฟกระพริบเตือนเมื่อเจอ Error หรือระบบหน่วง (Performance drop)
*   **Skill:** `superpower/brainstorm` — สามารถช่วยระดมสมอง (Brainstorm) เสนอแนวทางแก้ปัญหาและไอเดียใหม่ๆ เวลาระบบมีปัญหาหรือต้องการการตัดสินใจทางเทคนิคที่ซับซ้อน
